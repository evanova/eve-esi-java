...
final class CharacterRetrofit {
    ...
    public Character getCharacter(Long charID) throws IOException {
        ...
        final Character character = CharacterTransformer.transform(charID, r.body());
        addPortraits(character);
        addHistory(character);
        return character;
    }

    public Location getCharacterLocation(final Long charID) throws IOException {
    ...
    public Calendar getCalendar(Long charID, Long afterEventID)  throws IOException {
    ...
    private void addEvent(final Long charID, final GetCharactersCharacterIdCalendar200Ok object, final Calendar to) throws IOException {
    ...
    public boolean postCalendarEvent(Long charID, Long eventID, Calendar.Event.Response response) throws IOException {
    ...
    private void addPortraits(final Character to)  throws IOException{
    ...
    private void addHistory(final Character to)  throws IOException{
