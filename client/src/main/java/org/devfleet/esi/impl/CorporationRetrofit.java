...
final class CorporationRetrofit {
    ...
    public Corporation getCorporation(Long corpID) throws IOException {
        ...
        final Corporation corporation = CorporationTransformer.transform(corpID, r.body());
        addPortraits(corporation);
        addHistory(corporation);
        return corporation;
    }

    public List<Corporation.Member> getMembers(Long corpID) throws IOException {
        ...
        final List<Corporation.Member> returned = new ArrayList<>(members.size());
    ...
    private void addPortraits(final Corporation to) throws IOException {
    ...
    private void addHistory(final Corporation to) throws IOException {
